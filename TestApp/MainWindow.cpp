    ...
    ui(new Ui::MainWindow)
{
    ...
    QSharedPointer<IMapState> state2(new ViewPanState(), &QObject::deleteLater);
    ...
    MapGraphicsView * view2 = new MapGraphicsView(state2, scene, this);

    //The view will be our central widget
    QTabWidget* tabs = new QTabWidget;
    tabs->addTab(view, QIcon(":/images/assets/ic_menu_globe.png"), "Aerial View");
    tabs->addTab(view2, QIcon(":/images/assets/ic_menu_cards.png"), "Street View");
...
//    composite->addSourceTop(gridTiles);
    view->setTileSource(aerialTiles);
    view2->setTileSource(osmTiles);
...
//                                                                                         this->ui->dockWidget);
//    CompositeTileSourceConfigurationWidget * tileConfigWidget2 = new CompositeTileSourceConfigurationWidget(composite.toWeakRef(),
//                                                                                         this->ui->dockWidget);
//    this->ui->dockWidget->setWidget(tileConfigWidget);
//    this->ui->dockMapState->setWidget(tileConfigWidget2);
    ...
    polyObj->setZValue(200);
    polyObj->setOpacity(0.5);
